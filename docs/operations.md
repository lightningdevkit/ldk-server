...
| `<network_dir>/ldk_node_data.sqlite` or configured PostgreSQL database   | **Critical** | Channel state, on-chain wallet data, and payment history. Required to recover channel funds. |
