...
use ldk_server_grpc::api::{
	...
	ListChannelForwardingStatsRequest, ListChannelForwardingStatsResponse,
...
use ldk_server_grpc::endpoints::{
	...
	LIST_CHANNEL_PAIR_FORWARDING_STATS_PATH, LIST_FORWARDED_PAYMENTS_PATH, LIST_PAYMENTS_PATH,
