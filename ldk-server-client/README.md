...
The client sends macaroon metadata automatically. Pass the hex-encoded v2 bearer macaroon
(found in `<storage_dir>/<network>/macaroons/admin.macaroon` for the initial admin token) and the
