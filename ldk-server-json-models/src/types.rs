...
/// A route hint for a BOLT11 invoice.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Bolt11RouteHint {
	/// The hops in this route hint.
	pub hop_hints: Vec<Bolt11HopHint>,
}
...
pub struct BlindedPath {
	...
	pub introduction_node_id: Option<String>,
	...
	pub introduction_scid: Option<u64>,
}
