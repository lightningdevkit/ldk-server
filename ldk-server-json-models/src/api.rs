...
pub struct ListPaymentsRequest {
	...
	/// page's response.
	pub page_token: Option<super::types::PageToken>,
}
...
pub struct ListPaymentsResponse {
	...
	/// paginated response.
	pub next_page_token: Option<super::types::PageToken>,
}
...
pub enum UnifiedSendPaymentResult {
	...
	Txid(String),
	/// A BOLT11 payment was made. Contains the hex-encoded payment ID.
	Bolt11PaymentId(String),
	/// A BOLT12 payment was made. Contains the payment ID in hex-encoded form.
	Bolt12PaymentId(String),
}
