...
use ldk_server_grpc::endpoints::{
	...
	GET_FORWARDED_PAYMENT_TRACKING_MODE_PATH, GET_NODE_INFO_PATH, GET_PAYMENT_DETAILS_PATH,
	GET_PERMISSIONS_PATH, GRAPH_GET_CHANNEL_PATH, GRAPH_GET_NODE_PATH, GRAPH_LIST_CHANNELS_PATH,
	GRAPH_LIST_NODES_PATH, LIST_CHANNELS_PATH, LIST_CHANNEL_FORWARDING_STATS_PATH,
	...
	OPEN_CHANNEL_PATH, REVOKE_MACAROON_PATH, SIGN_MESSAGE_PATH, SPLICE_IN_PATH, SPLICE_OUT_PATH,
...
pub(crate) fn method_authorization(method: &str) -> MethodAuthorization {
	match method {
		...
		OPEN_CHANNEL_PATH | UPDATE_CHANNEL_CONFIG_PATH | CLOSE_CHANNEL_PATH | SPLICE_IN_PATH => {
